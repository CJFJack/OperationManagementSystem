...
urlpatterns = [
    ...
    url(r'^config_history_detail/(?P<pk>[0-9]+)/$', views.ConfigHistoryDetailView.as_view(),
        name='config_history_detail'),
    url(r'^config_recover/(?P<history_id>[0-9]+)/$', views.config_recover, name='config_recover'),
]
